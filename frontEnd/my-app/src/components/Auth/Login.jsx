...
const Login = () => {
  ...
  const { postLogin, sentence, logError, auth } = useContext(AuthContext);
    ...
    <Box>
      ...
      <Box w={{base:"90%",sm:"90%",md:"60%",lg:"40%"}}  m="auto" mb="50px">
        <Center display="flex" m="auto" w="5%" mt="50px">
          ...
          <Text fontSize="5xl" fontWeight="lighter">
            In
          </Text>
        </Center>
        <Center mb="50px" fontWeight="lighter" fontSize="3xl">
        ...
        <FormControl className="Login_boxes" margin="auto" w="100%">
          ...
          {logError && (
            ...
            >
              Incorrect Crediantials
            </h1>
          )}
          <Center mt="30px">
            <span style={lineStyleL}></span> Or Sign in with{' '}
            <span style={lineStyleL}></span>
          </Center>
        </FormControl>
        <br />
        <br />
        ...
        <Center fontSize="md" mb="30px">
          {' '}
          In Order to Sign up with Different account{' '}
          <NavLink to="/signup">
            {' '}
            <Button ml="10px" bg="#0073ea" color="white">
              Sign up
            </Button>{' '}
          </NavLink>
        </Center>
