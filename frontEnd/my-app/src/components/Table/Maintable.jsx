 ...
 const ok=useContext(AuthContext)
    ...
    async function  addtodo(){
        ...
        let obj={
             ...
             todo:[{status:false,title:"item", priority:"Low",startDate:"11-11-2022",
             endDate:"12-12-2022"}],
            }
...
<Box><Navigation/></Box>
<Box  w="100%">
<Box    pt="50px" ml="0px">{state.length==0?<Box><Image m="auto" src="https://cdn.dribbble.com/users/1753953/screenshots/3818675/animasi-emptystate.gif"/></Box>:state.map((ele,i)=>
<Box pb="100px"><Childtable  state={ele}  getdata={getdata} i={i}/></Box>

)}</Box>
<VStack><Box pb="100px" display="flex" justifyContent="center" m="auto"><Button  onClick={addtodo}>Add Group</Button></Box></VStack>
</Box>
</Box>
