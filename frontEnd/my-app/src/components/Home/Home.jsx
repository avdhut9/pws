  ...
  return (
    <Box w="100%">
      <Box bgColor={'#0c0d44'}>
          ...
          >
            <GridItem>
              <Box
                ...
                borderColor="#777794"
                borderRadius={7}
                _hover={{ borderColor: 'pink', cursor: 'pointer' }}
                height="130px"
                w="120px"
              >
                <Checkbox
                ...
                <Image
                  w="35%"
                  m="auto"
                  src="https://dapulse-res.cloudinary.com/image/upload/f_auto,q_auto/Generator_featured images/Home Page - 2022 Rebrand/first_fold/icons/marketing_icon.png"
                />
            ...
            <GridItem>
              <Box
                ...
                borderColor="#777794"
                borderRadius={7}
                _hover={{ borderColor: 'green.100', cursor: 'pointer' }}
                height="130px"
                w="120px"
              >
                <Checkbox
            ...
            <GridItem>
              ...
              >
                ...
                <Image
                  w="35%"
                  m="auto"
                  src="https://dapulse-res.cloudinary.com/image/upload/f_auto,q_auto/Generator_featured images/Home Page - 2022 Rebrand/first_fold/icons/hr_icon.png"
                />
            ...
            <GridItem>
              <Box
                ...
                borderColor="#777794"
                borderRadius={7}
                _hover={{ borderColor: 'blue', cursor: 'pointer' }}
                height="130px"
                w="120px"
              >
                <Checkbox
            ...
            <GridItem>
              ...
              >
                ...
                <Image
                  w="35%"
                  m="auto"
                  src="https://dapulse-res.cloudinary.com/image/upload/f_auto,q_auto/Generator_featured images/Home Page - 2022 Rebrand/first_fold/icons/operations_icon.png"
                />
        ...
        <Buttonx />
        <Text color="white" margin="auto" textAlign="center" p="20px">
      ...
      <Box bgColor="white">
        <VStack p="20px">
          <Text textAlign="center" margin="auto" fontSize="21px">
