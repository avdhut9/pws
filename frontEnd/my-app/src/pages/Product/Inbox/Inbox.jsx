  ...
  return (
    <Accordion defaultActiveKey={['0']} alwaysOpen>
        ...
        <Accordion.Body>
         <div className='user'>
            ...
            <div className='WElcome'>
             ...
             <div> <Button variant="primay">+</Button>{' '} </div>
             </div>
             <div> <h4>Invite your team mates and start collaborating</h4> </div>
             <div>
             <div></div>
             </div>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header><h6>Recent</h6></Accordion.Header>
        <Accordion.Body>
        <div className='user'>
            <div></div>
        ...
        <Accordion.Header><h6>My Workspace</h6></Accordion.Header>
        <Accordion.Body>
        <div className='user'>
            <div></div>
